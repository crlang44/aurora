...
<html>
	...
	<body class="homepage" onload="initialize(0)">
		<div id="page-wrapper">
				...
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<div class="container">
								<img src="images/logo.png" alt="NidhalDesign">
								</div>
								
								<h1><a href="index.html" id="logo">Aurora</a></h1>
								<hr />
								<p> &nbsp; &nbsp;Stock Market Metrics from Twitter &nbsp; &nbsp;</p>
							</header>
							<footer>
			...
			<!-- Banner -->
				<section id="banner">
					<header>
						<h2>Hi. Welcome to <strong>Aurora</strong>.</h2>
						<p>
		...
		<!-- Scripts -->
			...
			<script src="assets/js/inputscript.js"></script>
